...
class CircuitBreaker:
    ...
    def allow_request(self) -> bool:
        ...
        Uses time.monotonic() for elapsed time comparison.
        """
    ...
    def record_failure(self) -> None:
        ...
        IMPORTANT: HALF_OPEN and threshold cases use DIFFERENT reasons
    ...
    def _transition(self, new_state: CircuitState, reason: str) -> None:
        ...
        self.transition_log.append(
            {"from": self.state.value, "to": new_state.value, "reason": reason, "ts": _time.time()}
        )
